...
public class MetricUtils {
	...
	/**
	 * Calculates the DCG (Discounted cumulative gain) score for the specified
	 * ranking evaluation.
	 *
	 * @param ranking
	...
	/**
	 * Calculates the DCG (Discounted cumulative gain) score for the specified
	 * evaluation score at the specified rank position.
	 *
	 * @param score
	...
	/**
	 * Calculates the NDCG (Normalized discounted cumulative gain) score for the
	 * specified ranking evaluation.
	 *
	 * @param ranking
	 *            the ranking evaluation
